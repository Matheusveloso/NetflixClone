...
export default () =>{
  ...
  useEffect(() =>{
    const loadAll = async () =>{
      ...
      let radomChosen = Math.floor(Math.random() * (originals[0].items.results.length -1));//pega de forma aleatoria dos originais netflix
  ...
  return(
    <div className="page">
      ...
      <footer>
        Feito com <span role="img" aria-label="coração">❤</span> Por Matheus Veloso<br/>
